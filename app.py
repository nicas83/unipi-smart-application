...
def get_kpi_by_name(kpi_name):
    try:
        ...
        if kpi_name.upper() == 'OEE':
            ...
            kpis = [
                {"kpi_name": "AV", "value": 4.5, "taxonomy": "PRODUCTION", "group_by": "ALL", "date": "2023-11-24"}]
        elif kpi_name.upper() == "AQ":
            kpis = [
                {"kpi_name": "AQ", "value": 11.7, "taxonomy": "PRODUCTION", "group_by": "ALL", "date": "2023-11-25"}]
        elif kpi_name.upper() == "PE":
            kpis = [
                {"kpi_name": "PE", "value": 3.7, "taxonomy": "PRODUCTION", "group_by": "ALL", "date": "2023-11-25"}]
...
def get_all_kpi():
    try:
        ...
        kpis = [
            ...
            {"kpi_name": "AV", "value": 5, "taxonomy": "", "group_by": "", "date": "2023-11-24"},
            {"kpi_name": "AQ", "value": 3.7, "taxonomy": "", "group_by": "", "date": "2023-11-25"},
            {"kpi_name": "PE", "value": 0.7, "taxonomy": "", "group_by": "", "date": "2023-11-25"},
            {"kpi_name": "PRODUCTION_VOLUME", "value": 200, "taxonomy": "", "group_by": "", "date": "2023-11-25"},
            {"kpi_name": "DOWNTIME_RATE", "value": 0.7, "taxonomy": "", "group_by": "", "date": "2023-11-25"},
            {"kpi_name": "ENERGY_CONSUMPTION", "value": 320.7, "taxonomy": "", "group_by": "", "date": "2023-11-25"},
            {"kpi_name": "AHA", "value": 10.7, "taxonomy": "", "group_by": "", "date": "2023-11-25"},
            {"kpi_name": "EH", "value": 10.7, "taxonomy": "", "group_by": "", "date": "2023-11-25"}
        ]
...
@app.route('/kpis/{kpi_name}/stats', methods=['GET'])
def get_kpi_stats(kpi_name):
    kpis = None
    if kpi_name == '' or kpi_name.upper() == 'ALL':
        # all kpis
        kpis = [
            {"kpi_name": "OEE", "execution_time": 10.2, "date": "2023-11-23", "details": {"api_name": "/kpi/oee",
                                                                                          "num_call": "34"}},
            {"kpi_name": "AV", "execution_time": 3, "date": "2023-11-23", "details": {"api_name": "/kpi/av",
                                                                                      "num_call": "11"}},
            {"kpi_name": "AQ", "execution_time": 5.7, "date": "2023-11-23", "details": {"api_name": "/kpi/aq",
                                                                                        "num_call": "12"}},
            {"kpi_name": "PE", "execution_time": 2.7, "date": "2023-11-23", "details": {"api_name": "/kpi/pe",
                                                                                        "num_call": "5"}},
            {"kpi_name": "PRODUCTION_VOLUME", "execution_time": 2.7, "date": "2023-11-23",
             "details": {"api_name": "/kpi/production_volume", "num_call": "12"}},
            {"kpi_name": "ENERGY_CONSUMPTION", "execution_time": 4.7, "date": "2023-11-23",
             "details": {"api_name": "/kpi/energy_consumption", "num_call": "12"}},
            {"kpi_name": "DOWNTIME_RATE", "execution_time": 14.7, "date": "2023-11-23",
             "details": {"api_name": "/kpi/downtime_rate", "num_call": "12"}}
        ]
    elif kpi_name.upper() == 'OEE':
        # oee
        kpis = [
            {"kpi_name": "OEE", "execution_time": 10.2, "date": "2023-11-23", "details": {"api_name": "/kpi/aha",
                                                                                          "num_call": "12"}}]
    elif kpi_name.upper() == 'AV':
        # av
        kpis = [
            {"kpi_name": "AV", "execution_time": 5.4, "date": "2023-11-23", "details": {"api_name": "/kpi/aha",
                                                                                        "num_call": "11"}}]
    elif kpi_name.upper() == 'AQ':
        # aq
        kpis = [
            {"kpi_name": "AQ", "execution_time": 3.7, "date": "2023-11-23", "details": {"api_name": "/kpi/aha",
                                                                                        "num_call": "34"}}]
    elif kpi_name.upper() == 'PE':
        # pe
        kpis = [
            {"kpi_name": "PE", "execution_time": 7.3, "date": "2023-11-23", "details": {"api_name": "/kpi/aha",
                                                                                        "num_call": "124"}}]
    elif kpi_name.upper() == 'AHA':
        # aha
        kpis = [
            {"kpi_name": "AHA", "execution_time": 12.5, "date": "2023-11-23", "details": {"api_name": "/kpi/aha",
                                                                                          "num_call": "3"}}]
    elif kpi_name.upper() == 'EH':
        # eh
        kpis = [
            {"kpi_name": "EH", "execution_time": 45.2, "date": "2023-11-23",
             "details": {"api_name": "/kpi/aha", "num_call": "23"}}]
    elif kpi_name.upper() == 'DOWNTIME_RATE':
        # downtime rate
        kpis = [
            {"kpi_name": "DOWNTIME_RATE", "execution_time": 2.2, "date": "2023-11-23",
             "details": {"api_name": "/kpi/aha", "num_call": "41"}}]
    elif kpi_name.upper() == 'ENERGY_CONSUMPTION':
        # energy consumption
        kpis = [
            {"kpi_name": "ENERGY_CONSUMPTION", "execution_time": 8.2, "date": "2023-11-23",
             "details": {"api_name": "/kpi/aha", "num_call": "13"}}]
    elif kpi_name.upper() == 'PRODUCTION_VOLUME':
        # production volume
        kpis = [
            {"kpi_name": "PRODUCTION_VOLUME", "execution_time": 3.2, "date": "2023-11-23",
